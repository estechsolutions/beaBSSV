...
import be.e1.bssv.util.J564103.RunBatchJob;
...
public class BE_RunUBEManager extends PublishedBusinessService
{
    ...
    throws BusinessServiceException
  {
    ...
    try
    {
      ...
      LaunchUBE_D5641042A internalVO = new LaunchUBE_D5641042A();
      ...
      messages.addMessages(RunBatchJob.InternalLaunchR5641042(context, connection, internalVO));     
