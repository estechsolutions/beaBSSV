...
import be.e1.bssv.util.JP560200.valueobject.EmailAddressReply;
import be.e1.bssv.util.JP560200.valueobject.EmailAddressRequest;
...
public class BE_EmailManager extends PublishedBusinessService 
{
    ...
    public EmailAddressReply GetEmailAddress(EmailAddressRequest vo) throws BusinessServiceException 
    {
    ...
    protected EmailAddressReply GetEmailAddress(IContext context, IConnection connection, EmailAddressRequest vo) throws BusinessServiceException 
    {
      //perform all work within try block, finally will clean up any connections.
      try 
      {
          ...
          internalVO.setCCharacterParm(vo.getCharParm());
          internalVO.setSzParameter01(vo.getStringParm01());
          internalVO.setSzParameter02(vo.getStringParm02());
          internalVO.setSzParameter03(vo.getStringParm03());
          ...
          //Exception was not thrown, so create the confirm VO from internal VO
          EmailAddressReply confirmVO = new EmailAddressReply(internalVO);
          confirmVO.setE1MessageList(messages);
