...
public class BE_RunUBEManager extends PublishedBusinessService {
    ...
    protected UBEReply runUBE(IContext context, IConnection connection, UBERequest vo) throws BusinessServiceException {
        ...
        try {
            ...
            internalDS.setSzOutputFileName(vo.getObjectName());
            internalDS.setSzOutputFileLink(vo.getVersionHistory());
            internalDS.setSzPrintQueue(vo.getJDEnterpriseOneEventPoint01());
           
            BE_RunUBEManager.InternalrunUBE(context, connection, internalDS);
