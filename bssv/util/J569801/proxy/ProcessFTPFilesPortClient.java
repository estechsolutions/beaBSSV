...
public class ProcessFTPFilesPortClient
{
  private ProcessFTPFiles _port;
  private List<CredentialProvider> _credProviders;

  @Generated("Oracle JDeveloper")
  public ProcessFTPFilesPortClient()
    throws Exception
  {
    Processftpfiles_Client_Ep service = new Processftpfiles_Client_Ep_Impl();
    _port = service.getProcessFTPFiles_Pt();
  }
  ...
  public static void main(String[] args)
  {
    try
    {
      ProcessFTPFilesPortClient client = new ProcessFTPFilesPortClient();
  ...
  @Generated("Oracle JDeveloper")
  public ProcessFTPFiles getPort()
  {
    return _port;
  }
  ...
  @Generated("Oracle JDeveloper")
  public ProcessResponse process(Process payload)
  ...
  @Generated("Oracle JDeveloper")
  public void processAsync(AsyncPreCallContext apc, Process payload)
    throws RemoteException
  {
