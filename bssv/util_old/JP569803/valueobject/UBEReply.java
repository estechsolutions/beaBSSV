...
public class UBEReply extends MessageValueObject implements Serializable {
     ...
     */
    private String workflowTransportData = null;
    ...
    setWorkflowTransportData(vo.getSzOutputFileLink());
    ...
    public void setWorkflowTransportData(String workflowTransportData) {
        this.workflowTransportData = workflowTransportData;
    }

    public String getWorkflowTransportData() {
        return workflowTransportData;
    }
